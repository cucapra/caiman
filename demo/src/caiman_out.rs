...
pub type _lt_i32_i32 = (i32, );
pub type sum = (i32, );
pub type negate = ([i32; 4], );
}
pub trait CpuFunctions
{
	fn _lt_i32_i32(&self, state : &mut caiman_rt::State, _ : i32, _ : i32) -> outputs::_lt_i32_i32;
	fn sum(&self, state : &mut caiman_rt::State, _ : [i32; 4]) -> outputs::sum;
	fn negate(&self, state : &mut caiman_rt::State, _ : [i32; 4]) -> outputs::negate;
}
fn funclet4_func<'state,  'cpu_functions, 'callee, Callbacks : CpuFunctions>(mut instance : Instance<'state, 'cpu_functions, Callbacks>, join_stack : &mut caiman_rt::JoinStack<'callee>, var_0 : [i32; 4], var_1 : [i32; 4], var_2 : [i32; 4] ) -> FuncletResult<'state, 'cpu_functions, 'callee, Callbacks, PipelineOutputTuple<'callee>>
{
	use std::convert::TryInto;
//  node #0: Phi { index: 0 }
//  node #1: Phi { index: 1 }
//  node #2: Phi { index: 2 }
//  node #3: AllocTemporary { place: Local, storage_type: TypeId(7), buffer_flags: BufferFlags { map_read: true, map_write: true, copy_src: true, copy_dst: true, storage: false, uniform: false } }
instance.locals.malloc::<i32>(3);
...
*instance.locals.calloc::<i32>(5, var_4.0);
*instance.locals.get_mut::<i32>(3) = (*instance.locals.get::<i32>(5));
//  node #5: ReadRef { storage_type: TypeId(7), source: 3 }
let var_6 = (*instance.locals.get::<i32>(3));
instance.locals.calloc::<i32>(6, var_6);
//  node #6: AllocTemporary { place: Local, storage_type: TypeId(7), buffer_flags: BufferFlags { map_read: true, map_write: true, copy_src: true, copy_dst: true, storage: false, uniform: false } }
instance.locals.malloc::<i32>(7);
//  node #7: LocalDoBuiltin { operation: Node { node_id: 9 }, inputs: [], outputs: [6] }
instance.locals.calloc::<i32>(8, 0);
*instance.locals.get_mut::<i32>(7) = (*instance.locals.get::<i32>(8));
//  node #8: ReadRef { storage_type: TypeId(7), source: 6 }
let var_9 = (*instance.locals.get::<i32>(7));
instance.locals.calloc::<i32>(9, var_9);
...
let var_11 = instance.cpu_functions._lt_i32_i32(instance.state, var_6, var_9);
...
//  node #1: Phi { index: 1 }
//  node #2: AllocTemporary { place: Local, storage_type: TypeId(2), buffer_flags: BufferFlags { map_read: true, map_write: true, copy_src: true, copy_dst: true, storage: false, uniform: false } }
instance.locals.malloc::<[i32; 4]>(15);
//  node #3: LocalDoExternal { operation: Node { node_id: 5 }, external_function_id: ExternalFunctionId(3), inputs: [0], outputs: [2] }
let var_16 = instance.cpu_functions.negate(instance.state, var_1);
*instance.locals.calloc::<[i32; 4]>(17, var_16.0);
*instance.locals.get_mut::<[i32; 4]>(15) = (*instance.locals.get::<[i32; 4]>(17));
//  node #4: ReadRef { storage_type: TypeId(2), source: 2 }
let var_18 = (*instance.locals.get::<[i32; 4]>(15));
instance.locals.calloc::<[i32; 4]>(18, var_18);
...
//  node #1: Phi { index: 1 }
//  node #2: AllocTemporary { place: Local, storage_type: TypeId(2), buffer_flags: BufferFlags { map_read: true, map_write: true, copy_src: true, copy_dst: true, storage: false, uniform: false } }
instance.locals.malloc::<[i32; 4]>(19);
//  node #3: LocalDoExternal { operation: Node { node_id: 7 }, external_function_id: ExternalFunctionId(3), inputs: [1], outputs: [2] }
let var_20 = instance.cpu_functions.negate(instance.state, var_2);
*instance.locals.calloc::<[i32; 4]>(21, var_20.0);
*instance.locals.get_mut::<[i32; 4]>(19) = (*instance.locals.get::<[i32; 4]>(21));
//  node #4: ReadRef { storage_type: TypeId(2), source: 2 }
let var_22 = (*instance.locals.get::<[i32; 4]>(19));
instance.locals.calloc::<[i32; 4]>(22, var_22);
//  tail edge: Return { return_values: [4] }
if join_stack.used_bytes().len() > 0 { return pop_join_and_dispatch_at_0::<Callbacks, PipelineOutputTuple<'callee>>(join_stack, var_22, instance) }return FuncletResult::<'state, 'cpu_functions, 'callee, Callbacks, _> {phantom : std::marker::PhantomData::<& 'callee ()>, intermediates : FuncletResultIntermediates::<_>::Return((var_22, )), instance}; }
		...
		type PipelineOutputTuple<'callee> = ([i32; 4], );
...
pub fn yielded_at__loop_impl(&self) -> Option<& ()> { if let FuncletResultIntermediates::Yield0{yielded} = & self.intermediates { Some(yielded) } else { None } }
		...
		impl<'state, 'cpu_functions, F : CpuFunctions> Instance<'state, 'cpu_functions, F>
{
pub fn start<'callee>(mut self, join_stack : &mut caiman_rt::JoinStack<'callee>, arg_0 : [i32; 4], arg_1 : [i32; 4], arg_2 : [i32; 4]) -> FuncletResult<'state, 'cpu_functions, 'callee, F, PipelineOutputTuple<'callee>> {
...
fn pop_join_and_dispatch_at_0<'state, 'cpu_functions, 'callee, Callbacks : CpuFunctions, Intermediates>(join_stack : &mut caiman_rt::JoinStack<'callee>, arg_0 : [i32; 4], mut instance : Instance<'state, 'cpu_functions, Callbacks> ) -> FuncletResult<'state, 'cpu_functions, 'callee, Callbacks, ([i32; 4], )>
{
let closure_header = unsafe { join_stack.pop_unsafe_unaligned::<ClosureHeader>().unwrap() }; match closure_header {
_ => panic!("Dispatcher cannot dispatch given closure {:?}", closure_header), } }fn pop_join_and_dispatch_at_1<'state, 'cpu_functions, 'callee, Callbacks : CpuFunctions, Intermediates>(join_stack : &mut caiman_rt::JoinStack<'callee>, mut instance : Instance<'state, 'cpu_functions, Callbacks> ) -> FuncletResult<'state, 'cpu_functions, 'callee, Callbacks, ([i32; 4], )>
{
let closure_header = unsafe { join_stack.pop_unsafe_unaligned::<ClosureHeader>().unwrap() }; match closure_header {
