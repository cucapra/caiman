...
pub fn concretize_input_to_internal_value_tag(program : & ir::Program, value_funclet_id_opt : Option<ir::FuncletId>, value_tag : ir::ValueTag) -> ir::ValueTag
{
	match value_tag
	{
...
pub fn check_value_tag_compatibility_enter(program : & ir::Program, value_funclet_id_opt : Option<ir::FuncletId>, call_operation : ir::RemoteNodeId, caller_value_tag : ir::ValueTag, callee_value_tag : ir::ValueTag)
{
...
pub fn check_value_tag_compatibility_interior_branch(program : & ir::Program, value_funclet_id_opt : Option<ir::FuncletId>, value_operation : ir::RemoteNodeId, condition_value_tag : ir::ValueTag, source_value_tags : &[ir::ValueTag], destination_value_tag : ir::ValueTag)
{
	...
	for (branch_index, branch_node_id) in branch_node_ids.iter().enumerate()
	{
		...
		match source_value_tag
		{
			...
			_ =>
			{
				check_value_tag_compatibility_interior(& program, value_funclet_id_opt, source_value_tag, destination_value_tag);
			}
		}
	}
}
...
pub fn check_value_tag_compatibility_interior(program : & ir::Program, value_funclet_id_opt : Option<ir::FuncletId>, source_value_tag : ir::ValueTag, destination_value_tag : ir::ValueTag)
{
	match (source_value_tag, destination_value_tag)
	{
