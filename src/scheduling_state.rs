...
impl SchedulingState {
    ...
    pub fn insert_submission<Listener>(
        &mut self,
        queue_place: ir::Place,
        listener: &mut Listener,
    ) -> SubmissionId
    where
        Listener: FnMut(&Self, &SchedulingEvent) -> (),
    {
        let timestamp = self.get_local_time();
    ...
    pub fn advance_known_place_time<Listener>(
        &mut self,
        place: ir::Place,
        known_timestamp: LogicalTimestamp,
        listener: &mut Listener,
