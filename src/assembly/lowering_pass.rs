...
use crate::assembly::ast::{
    ExternalFunctionId, FuncletId, OperationId, StorageTypeId, TypeId, ValueFunctionId,
};
...
//
// fn ir_external_cpu(
//     external: &ast::ExternalCpuFunction,
//     context: &mut Context,
...
//
// fn ir_external_gpu(
//     external: &ast::ExternalGpuFunction,
//     context: &mut Context,
...
// }
//
// fn ir_funclet(funclet: &ast::Funclet, context: &mut Context) -> Option<ir::Funclet> {
//     let mut input_types = Vec::new();
//     let mut output_types = Vec::new();
...
//         match funclet {
//             ast::FuncletDef::Local(f) => match f.kind {
...
// }
//
// fn setup_extras(extras: &ast::Extras, context: &mut Context) {
...
//                     match command {
//                         None => {}
//                         Some(ast::NamedNode { node: _, name }) => {
//                             if name == "_" {
//                                 *name = format!("~{}", number);
//                                 number += 1;
//                             }
