...
impl pipelines::pipeline_1::CpuFunctions for Callbacks {
    fn do_thing_on_cpu(
        ...
        value: i32,
    ) -> pipelines::pipeline_1::outputs::do_thing_on_cpu {
        return (value + 1,);
    }
}
...
impl pipelines::looping_pipeline::CpuFunctions for Callbacks {
    fn do_thing_on_cpu(
        ...
        state: &mut caiman_rt::State,
        value: i32,
    ) -> pipelines::looping_pipeline::outputs::do_thing_on_cpu {
        return (value + 1,);
    }
}
...
mod tests {
    ...
    fn test_pipeline_with_value_function() {
        ...
        let mut join_stack_bytes = [0u8; 4096usize];
        let mut join_stack = caiman_rt::JoinStack::new(&mut join_stack_bytes);
        let instance = crate::pipelines::pipeline_with_value_function::Instance::new(
            &mut root_state,
            &callbacks,
        );
        //let result = crate::pipelines::pipeline_1::run(&mut root_state, & callbacks, 1);
    ...
    fn test_pipeline_with_looping_value_function() {
        ...
        let mut join_stack = caiman_rt::JoinStack::new(&mut join_stack_bytes);
        let instance =
            crate::pipelines::looping_pipeline::Instance::new(&mut root_state, &callbacks);
