...
fn compile(input_file : &mut File, output_file : &mut File)
{
	...
	let result : Result<String, caiman::frontend::CompileError> = caiman::frontend::compile_ron_definition(& input_string, Some(caiman::frontend::CompileOptions{print_codegen_debug_info : true}));
