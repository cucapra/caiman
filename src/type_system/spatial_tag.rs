...
pub fn concretize_input_to_internal_spatial_tag(program : & ir::Program, funclet_id_opt : Option<ir::FuncletId>, spatial_tag : ir::SpatialTag) -> ir::SpatialTag
{
	match spatial_tag
	{
...
pub fn check_spatial_tag_compatibility_interior(program : & ir::Program, funclet_id_opt : Option<ir::FuncletId>, source_tag : ir::SpatialTag, destination_tag : ir::SpatialTag)
{
